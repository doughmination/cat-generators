...
OUT = ONEKO / "output" / "pride" / "genderfluid.png"

FRAME = 32  # sprite cell height in px

PINK = np.array([0xFF, 0x76, 0xA4]) / 255.0
WHITE = np.array([1.0, 1.0, 1.0])
PURPLE = np.array([0xC0, 0x11, 0xD7]) / 255.0
BLACK = np.array([0.0, 0.0, 0.0])
BLUE = np.array([0x2F, 0x3C, 0xBE]) / 255.0

BANDS = [PINK, WHITE, PURPLE, BLACK, BLUE]
