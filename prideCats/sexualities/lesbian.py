...
OUT = ONEKO / "output" / "pride" / "lesbian.png"

FRAME = 32  # sprite cell height in px

DARK_ORANGE = np.array([0xD5, 0x2D, 0x00]) / 255.0
ORANGE = np.array([0xFF, 0x9A, 0x56]) / 255.0
WHITE = np.array([1.0, 1.0, 1.0])
PINK = np.array([0xD3, 0x62, 0xA4]) / 255.0
DARK_ROSE = np.array([0xA3, 0x02, 0x62]) / 255.0

BANDS = [DARK_ORANGE, ORANGE, WHITE, PINK, DARK_ROSE]
